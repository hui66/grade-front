<template>
  <div class="m-home">
    ...
    <el-table-body align="center">
      <el-table-column style="align-content: center ; margin-top: 100px">
        i.工程知识指标：具备扎实的数学、自然科学知识基础，系统地掌握计算机领域的专业知识和工程基础，能够将所掌握的知识运用于解决计算机领域复杂工程问题。即：能帮助解决工程问题的纯理论知识。
      </el-table-column><br/>
      <el-table-column style="align-content: center">
        ii.设计/开发解决方案: 能够设计针对计算机领域复杂工程问题的解决方案，设计满足特定需求的软硬件系统、算法或模型，并能够在设计过程中体现创新意识，考虑社会、健康、安全、法律、文化以及环境等因素。即：设计开发，应用层面上的实践，能体现部分创新，但侧重点还是在设计和开发方面。
      </el-table-column><br/>
      <el-table-column>
        iii.研究：能够基于计算机领域科学原理，并采用科学方法，对复杂的计算机软硬件系统工程问题进行研究，包括设计实验、分析与解释数据、并通过信息综合、分析得到合理有效的结论。即：理论，创新，理论层面上的实践/建模/分析。
      </el-table-column><br/>
      <el-table-column>
        iv.个人和团队：能够在多学科交叉融合背景下的团队中承担个体、团队成员以及负责人的角色。即: 在团队中承担的角色（团队精神/团队协调）, 还包含个人作为负责人，独立完成以及组织协调能力的情形。
      </el-table-column><br/>
      <el-table-column>
        v.项目管理：理解并掌握计算机系统的工程管理原理与经济决策方法，并能将项目管理知识综合运用到多学科合作的环境中。即：能帮助了解/提升计算机工程管理原理与经济决策方法（间接或直接）的学科，以让学生有能力将项目管理知识综合运用到多学科合作的环境中。
      </el-table-column><br/>
    </el-table-body>
<!--    <el-row :gutter="20">-->
